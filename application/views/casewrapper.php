...
<head>
  ...
  <title><?php echo $this->config->item('siteName');?> - Case <?php echo $CaseNumber['word'];?></title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php
    $this->load->view('sidebar',array('CaseNumber' => array('number' => $CaseNumber['number'])));
    ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Case <?php echo $CaseNumber['number'];?> (<?php echo $CaseNumber['word'];?>)</h1>
          
          <?php
            if($CaseNumber['number'] == 1)
            {
