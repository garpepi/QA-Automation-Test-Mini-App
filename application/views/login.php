...
<head>
  ...
  <title><?php echo $this->config->item('siteName');?> - Login</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Well... Hello!!</h1>
                  </div>
                  <form class="user" method="POST" action="/login">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" placeholder="Candidate Name" name="name" required>
                    </div>
                    <hr>
                    <div class="form-group">
