  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url();?>/assets/index.html">
        ...
        <div class="sidebar-brand-text mx-3"><?php echo $this->config->item('siteName');?></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url();?>/assets/#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?php echo base_url();?>/assets/404.html">404 Page</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center">
            ...
            <a href="<?php echo base_url();?>/assets/index.html">&larr; Back to Dashboard</a>
          </div>
